...
command_pool::command_pool()
{
    ...
    vk_command_pool_create_info.queueFamilyIndex = device->get_physical_device()->GetQueueFamilyIndices().Graphics_family.value();
    ...
    vk_command_pool_create_info.queueFamilyIndex = device->get_physical_device()->GetQueueFamilyIndices().m_compute_family.value();
...
{
    auto device = vulkan_context::get()->get_device();
    flush_command_buffer(p_vk_command_buffer, device->get_vk_graphics_queue(), command_buffer_type_t::graphics);
}
