...
public:
	...
	virtual void add_resize_callback(const std::function<void(ref<frame_buffer>)>& func) override;
	...
	virtual ref<Image2D> get_image(uint32_t attachment_index = 0) const override
	{ 
	...
	virtual ref<Image2D> get_depth_image() const override { return m_depth_attachment_image; }
	...
	{
	    return m_depth_attachment_image != ref<Image2D>{};
	}
