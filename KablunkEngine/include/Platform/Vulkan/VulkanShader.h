...
public:
	...
	const kb::unordered_flat_map<std::string, ShaderBuffer>& GetShaderBuffers() const override
	{
	    return m_buffers;
	}

	const kb::unordered_flat_map<std::string, ShaderResourceDeclaration>& GetResources() const override
	{
	    return m_resources;
	}
