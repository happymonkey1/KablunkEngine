#pragma once
#ifndef KABLUNK_PLATFORM_OPENGL_RENDERER_2D_H
#define KABLUNK_PLATFORM_OPENGL_RENDERER_2D_H
...
namespace Kablunk
{
	...
	public:
		...
		virtual void Renderer2D_SetSceneRenderer(IntrusiveRef<SceneRenderer> scene_renderer) override { KB_CORE_ASSERT(false, "not implemented!") };
