...
#	define kb_new(T)				static_cast<decltype(T)*>(::Kablunk::memory::GeneralAllocator::get_mutable().allocate(sizeof(T), __FILE__, __LINE__))
#   define kb_new_array(T, count)	static_cast<T*>(::Kablunk::memory::GeneralAllocator::get_mutable().allocate(sizeof(T) * count, __FILE__, __LINE__))
#	define kb_delete(T)				::Kablunk::memory::GeneralAllocator::get_mutable().free((void*)T)
#	define kb_delete_array(T)		::Kablunk::memory::GeneralAllocator::get_mutable().free((void*)T);
#else
#	define kb_new(T)				new
