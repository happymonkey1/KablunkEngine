...
public:
	...
	int read_pixel(u32 attachment_index, int x, int y) override;
	void clear_attachment(u32 attachment_index, int value) override;
	...
	const frame_buffer_specification& get_specification() const override { return m_specification; }
    ...
    // Invalidate frame buffer object, scheduling invalidation on the render thread
	void invalidate();
