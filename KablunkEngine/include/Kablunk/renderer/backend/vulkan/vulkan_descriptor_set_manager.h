...
inline const char* k_render_pass_resource_type_names[k_render_pass_resource_type_name_size]
{
    "none",
    "uniform_buffer",
    "storage_buffer",
...
struct render_pass_input
{
    ...
    auto set(const arc<uniform_buffer_set>& p_storage_buffer_set, u32 p_index = 0) noexcept -> void
    {
        m_type = render_pass_resource_type_t::uniform_buffer_set;
        m_input[p_index] = arc<RefCounted>{ p_storage_buffer_set };
    }

    auto set(const arc<storage_buffer>& p_storage_buffer, u32 p_index = 0) noexcept -> void
    {
        m_type = render_pass_resource_type_t::storage_buffer;
        m_input[p_index] = arc<RefCounted>{ p_storage_buffer };
    }

    auto set(const arc<storage_buffer_set>& p_storage_buffer_set, u32 p_index = 0) noexcept -> void
    {
        m_type = render_pass_resource_type_t::storage_buffer_set;
        m_input[p_index] = arc<RefCounted>{ p_storage_buffer_set };
    }

    auto set(const arc<texture_2d>& p_texture, u32 p_index = 0) noexcept -> void
    {
        m_type = render_pass_resource_type_t::texture_2d;
        m_input[p_index] = arc<RefCounted>{ p_texture };
    }

    auto set(const arc<image_2d>& p_image, u32 p_index = 0) noexcept -> void
    {
        m_type = render_pass_resource_type_t::image_2d;
