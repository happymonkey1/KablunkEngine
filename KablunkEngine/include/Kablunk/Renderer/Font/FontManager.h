...
public:
    ...
    void add_font_file_to_library(ref<font_asset_t> font_asset, const std::filesystem::path& p_absolute_filepath);
	// check if a reference to the given font asset is in the cache
	bool has_font_cached(ref<font_asset_t> font_asset) const;
	...
	ref<font_asset_t> get_font_asset(asset::asset_id_t p_font_asset_id) const;
