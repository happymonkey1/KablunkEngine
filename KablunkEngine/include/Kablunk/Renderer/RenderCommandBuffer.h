...
{
public:
    ~RenderCommandBuffer() override = default;
	...
	static arc<RenderCommandBuffer> Create(uint32_t count = 0, const std::string& debug_name = "");
	static arc<RenderCommandBuffer> CreateFromSwapChain(const std::string& debug_name = "");
};
} // end namespace kb
